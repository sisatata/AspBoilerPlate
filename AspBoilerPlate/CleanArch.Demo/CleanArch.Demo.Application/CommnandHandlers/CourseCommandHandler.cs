...
{
    public class CourseCommandHandler : IRequestHandler<CreateCourseCommandV1, CommonResponseDto>
    {
        ...
        public async Task<CommonResponseDto> Handle(CreateCourseCommandV1 request, CancellationToken cancellationToken)
        {
